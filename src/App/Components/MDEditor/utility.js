import { suggestions, parameters, emptySet } from "../Objects/main.js";
...
export function getParametersMaxLen(array) {
  ...
  export function getParameterArray(array, index) {
    if (index == 0) return parameters[0];
    let fK = array[0];
    if (!parameters[0][array]) return emptySet;
